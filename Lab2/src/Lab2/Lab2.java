...
public class Lab2 {
    ...
    private static void makeComputation() throws InterruptedException {
        ...
        // Замість методу Join використано синхронізатор типу CountDownLatch
        CountDownLatch awaiterFirst = new CountDownLatch(4);
        ...
        // Замість методу Join використано синхронізатор типу CountDownLatch
        CountDownLatch awaiterSecond = new CountDownLatch(3);
        ...
        CountDownLatch awaiterFinal = new CountDownLatch(2);
